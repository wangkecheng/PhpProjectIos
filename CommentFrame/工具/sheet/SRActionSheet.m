...
- (void)show{
    [self showWithSuperVC:CurrentAppDelegate.window];
}
         ...
         usingSpringWithDamping:0.9
          initialSpringVelocity:0.7
                     ...
                     animations:^{
                         ...
                         weakSelf.actionSheet.transform = CGAffineTransformMakeTranslation(0, -weakSelf.actionSheetHeight);
                     }
                     completion:nil];
}
         ...
         usingSpringWithDamping:0.9
          initialSpringVelocity:0.7
                     ...
                     animations:^{
                         ...
                         weakSelf.actionSheet.transform = CGAffineTransformIdentity;
                     }
                     completion:^(BOOL finished) {
                         [weakSelf removeFromSuperview];
                         if (weakSelf.sRActionSheetDissMissBlock) {
                             weakSelf.sRActionSheetDissMissBlock();
                         }
                     }];
}
