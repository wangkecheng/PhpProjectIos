...
{
    CGRect absoluteRect = [view convertRect:view.bounds toView:CurrentAppDelegate.window];
...
- (void)show
{
    [CurrentAppDelegate.window addSubview:_menuBackView];
...
- (void)setDefaultSettings
{
    ...
    _backColor = [UIColor whiteColor];
     self.type = YBPopupMenuTypeDefault;//懒加载
    ...
    _menuBackView.backgroundColor = [[UIColor whiteColor] colorWithAlphaComponent:0.1];
    _menuBackView.alpha = 0;
