...
-(void)setupUI {
    ...
    [self.showYearView setTextColor:[UIColor clearColor]];//去掉后就没有背景年份
}
...
-(void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        label.textColor = [UIColor blackColor]; //RGB(247, 133, 51);
...
-(void)show {
    ...
    [UIView animateWithDuration:.3 animations:^{
        self.bottomConstraint.constant = 0;//设置视图到底部的距离
